    ...
    if screenGui then
        ...
        if magicHealthFrame then
            ...
            if textLabel then
                ...
                textLabel.Text = "HELLBOUND ELECTRIC"
...
AnimAnim.AnimationId = "rbxassetid://18716660379"
